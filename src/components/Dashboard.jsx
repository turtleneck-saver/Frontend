  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* 오늘의 요약 (도넛) */}
        <div style={{ ...cardStyle, gridColumn: '1 / span 2', minHeight: '300px' }}>
          <DailyStatsCard />
        </div>

        {/* 주간 차트: 막대 + 선형 */}
        <div style={{ display: 'flex', gap: '30px', gridColumn: '1 / span 2', width: '100%' }}>
        ...
        <div style={{ display: 'flex', gap: '30px', gridColumn: '1 / span 2' }}>
          ...
          <div style={{
            ...
            <p style={{ marginTop: '1rem' }}>📏 평균 각도: <strong>41.3°</strong></p>
          </div>
        </div>
      </div>
    </div>
